...
<body data-bs-spy="scroll" data-bs-target="#nav_res">
    ...
    <header class="landing_custom h-cutmize d-flex text-black flex-column justify-content-center align-items-center">
        ...
        <div class="row d-flex  text-black flex-row justify-content-center align-items-center">
            <div class="row col-6 col-lg-3">
                ...
                <a class="cu_tom_ancor position-relative" href="./creams.php">
                    <i class="bi bi-check fs-4 pos_right_mark"></i>
                    <p class="fs-6 custom_cursor text_custom">Cream</p>
                </a>
            ...
            <div class="row">
                <img src="./images/logo.png" class="w-10" alt="">
                    ...
                    <div class="total_imagess col-lg-11 my-5 mx-auto d-flex flex-wrap flex-column flex-lg-row justify-content-lg-between">
                        <?php 
                            foreach(glob('./images/creams/*.*') as $filename){
