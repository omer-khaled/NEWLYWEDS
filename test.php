...
<body>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <form action="test_operation.php" id="added"  method='POST' enctype='multipart/form-data'>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label text_custom">number</label>
                <input type="number" required class="form-control" name="number" id="new_number">
            </div>
