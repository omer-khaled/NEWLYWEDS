...
<body data-bs-spy="scroll" data-bs-target="#nav_res">
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse text-center collapse " id="navbarNav">
                <ul class="navbar-nav ms-auto flex-lg-row  flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link active_om me-lg-3" number="0" href="#prooo">About__us</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <header class="landing_custom h-cutmize d-flex flex-column justify-content-center align-items-center">
        <svg id="wave" class="d-block" style="transform:rotate(0deg); transition: 0.3s" viewBox="0 0 1440 100" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <defs>
    ...
    <section class="abut mt-5_ci">
        <div class="container">
            <div class="row">
                <img src="./images/logo.png" class="w-10" alt="">
                <h2 class="heading text-center my-4">Our Story</h2>
            </div>
            <p class="fs-5 text-white w-75 mx-auto text-rigth">
                Pralineco General Trading is a leading key distributor company in the Middle East & GCC region, with years of experience in the Hospitality; F&B Industry; Chocolate, Pastry & Bakery production, along with high-end professionals Equipment & Machinery. pralineco Produce high end Chocolate pralines wrapped and unwrapped , in different flavors , shapes , and sizes enrobed in chocolate, pralineco use high end premium Belgium & Italian raw materials for its production, pralineco factory produce 100 Ton per month of Chocolates, ice cream powders, ready mix powders, syrups, creams and sauces
            </p>
        </div>
    ...
    <section class="aboutus mb-6 overflow-hidden" id="prooo">
        <div class="container">
            <div class="row">
                <h2 class="h2 text-center text_custom mt-5">Mission and Vision</h2>
                <p class="h5 text-center text-white mt-2 mx-auto w-75 cutom_peoo">Diversity and creativity with high quality and building a constructive partnership we maintain.On the confidentiality and credibility of each partner and initiator</p>
                <div class="row flex-column mt-1 mx-auto d-flex flex-column flex-lg-row justify-content-lg-between">
